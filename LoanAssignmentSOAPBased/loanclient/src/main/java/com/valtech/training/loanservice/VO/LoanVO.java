package com.valtech.training.loanservice.VO;
...
public record LoanVO(long id,String name,LoanType loanType,int pan,int aadhar,int cibilScore,String asset,int value,com.valtech.training.loanserverservice.entities.Loan.LoanStatus loanStatus){
